...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/molsystem-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12659&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/molsystem-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `molsystem` can be installed with:

```
conda install molsystem
```

It is possible to list all of the versions of `molsystem` available on your platform with:
